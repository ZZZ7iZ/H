...
from jepthon import StartTime, sbb_b, JEPVERSION
...
@sbb_b.on(admin_cmd(pattern=f"{ALIVE_ET}(?:\s|$)([\s\S]*)"))
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ 𝚂𝙾𝙺𝚁𝙲𝙴  𝙲𝙰𝙻𝙸𝙿𝙷 ✓ ](t.me/ZZZ7iZ)父**"
